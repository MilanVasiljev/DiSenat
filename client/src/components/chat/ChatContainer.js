...
class ChatContainer extends Component {
    ...
    // DODAVANJE I BRISANJE LJUDI U VEC POSTOJECI CHAT
                ...
                <div className="chat-room-container">
                    {
                        activeChat !== null ? (
                            ...
                            <div className="chat-room choose">
                                <h3>Izaberite sagovornika (nema aktivnog razgovora)</h3>
                            </div>
                    }
                </div>
